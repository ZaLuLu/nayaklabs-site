      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-[var(--border-base)]">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-8 pr-3 py-1 bg-[var(--bg-surface)] border border-[var(--border-base)] text-xs text-[var(--text-primary)] font-mono placeholder:text-[var(--text-muted)] focus:outline-none focus:border-[var(--border-hover)] rounded-xs w-44 sm:w-56"
          />
        </div>
      </div>
        ...
        {filteredEvents.length === 0 ? (
          ...
          filteredEvents.map((evt) => {
            ...
            return (
              <div
                key={evt.id}
                className="bg-[var(--bg-surface)] border border-[var(--border-base)] hover:border-[var(--border-hover)] p-4 flex flex-col justify-between transition-all rounded-xs group relative"
              >
                <div>
                  <div className="flex items-center justify-between gap-2 mb-2">
                    <span className="px-2 py-0.5 bg-[var(--bg-card)] border border-[var(--border-base)] text-[var(--text-secondary)] font-mono text-[0.62rem] font-semibold uppercase tracking-wider rounded-xs">
                      {evt.category}
                    </span>
                    {evt.isHot && (
                      <span className="font-mono text-[0.58rem] text-orange-500 font-bold">
                        ● TRENDING
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex flex-col gap-1 font-mono text-[0.65rem] text-[var(--text-muted)]">
                ...
                <div className="flex items-center justify-between pt-3 mt-3 border-t border-[var(--border-base)] font-mono text-[0.65rem]">
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1 flex items-center gap-1 font-mono text-[0.65rem] font-semibold transition-colors cursor-pointer rounded-xs ${
                      isJoined
